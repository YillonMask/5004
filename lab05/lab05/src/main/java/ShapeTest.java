...
public class ShapeTest {
  ...
  Shape circle1, circle2, circle3, rect1, rect2, trian1, trian2, trian3;
  ...
  public void setup() {
    ...
    trian1 = new Triangle(1.0, 2.0, 0.0, 3, -1.0, 0.0);
    trian2 = new Triangle(1.0, 2.0, 2, 4, 3, 6);
  ...
  public void testObjectData() {
    ...
    assertEquals("Rectangle: LL corner (2.000,3.000) width 10.000 height 10" +
        ...
        rect2
            .toString());
    assertEquals("Triangle: the reference point is (1.000, 2.000), the other two " +
        "points are (0.000, 3.000),(-1.000,0.000)", trian1.toString());
  }

  /**
   * Tests if two additional points are the same
   * the IllegalArgumentException will be thrown
   */
  @Test
  public void testTriUniquePoints() {
    assertThrows(IllegalArgumentException.class, () -> {
      trian3 = new Triangle(1, 2, 3, 4, 3, 4);
    });
  }
  ...
  public void testArea() {
    ...
    assertEquals(0, trian2.area(), 0.001);
    assertEquals(2.0, trian1.area(), 0.001);
  ...
  public void testPerimeter() {
    ...
    assertEquals(7.4049, trian1.perimeter(), 0.001);
    assertEquals(8.944, trian2.perimeter(), 0.001);
  }
